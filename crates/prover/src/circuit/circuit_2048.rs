...
pub struct Email2048CircuitInput {
...
impl Email2048CircuitInput {
    ...
    pub fn synthesize(&self) -> Composer<Fr> {
        ...
        // gen pub_inputs
        // hash all public. 3040 bits (256|256|2048|192|256|16|16)
        ...
        let all_public_hash =
            sha256_no_padding_words_var_fixed_length(&mut cs, &sha256_all_public_data, 7).unwrap();
...
mod tests {
    ...
    use crate::{
        circuit::circuit_2048::Email2048CircuitInput,
